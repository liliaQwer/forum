...
const DELETE_COMFIRM = "Are you really want to delete your post?"
...
export  {
    ...
    GO_TO_MAIN_PAGE, EDIT, POST_EDIT_CAPTION, POST_EDIT_SUCCESS, CANCEL, DELETE, DELETE_COMFIRM, POST_DELETE_SUCCESS
}