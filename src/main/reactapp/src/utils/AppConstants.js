...
const COMMENT_ADD_CAPTION = "You can add a new comment to the post here"

const POST_ADD_SUCCESS = "Your post was added!"
const POST_EDIT_SUCCESS = "Your post was updated!"
const POST_DELETE_SUCCESS = "Your post was deleted!";
const DELETE_POST_CONFIRM = "Are you really want to delete your post?";
const DELETE_COMMENT_CONFIRM = "Are you really want to delete your comment?"
const COMMENT_DELETE_SUCCESS = "Your comment was deleted!";
const COMMENT_ADD_SUCCESS = "Your comment was added!"
...
export  {
    ...
    GO_TO_MAIN_PAGE, EDIT, POST_EDIT_CAPTION, POST_EDIT_SUCCESS, CANCEL, DELETE, DELETE_POST_CONFIRM, POST_DELETE_SUCCESS,
    COMMENT_ADD_CAPTION, DELETE_COMMENT_CONFIRM, COMMENT_DELETE_SUCCESS, COMMENT_ADD_SUCCESS
}